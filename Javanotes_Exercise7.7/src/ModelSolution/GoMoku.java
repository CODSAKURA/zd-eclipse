...
public class GoMoku extends Application {
    ...
    private class GoMokuBoard extends Canvas {
        ...
        private int count(int player, int row, int col, int dirX, int dirY) {
            ...
            //	My explanation: r keeps changing until it reaches the last one which is not suitable for the while loop.
            //  In order to get the last square of a continuous square then we have to move backward an element.
            ...
            win_r2 = r + dirX;//My explanation: r keeps changing until it reaches the last one which is not suitable for the while loop.	  
            win_c2 = c + dirY;//In order to get the last square of a continuous square then we have to move backward an element.
