...
public class Main1 {
   ...
   public static void main(String[] args) {
       ...
       boolean[] usedTwice = new boolean[365];
       ...
       while (true) {
          ...
          if(used[birthday] && usedTwice[birthday])
          {
        	  break;
          }
          else if ( used[birthday] ) {  
                
             usedTwice[birthday] = true;
          }
          else
          {
        	  used[birthday] = true;
       ...
       System.out.println();
       System.out.println("A tripod birthday was found after " 
                                             + count + " tries.");
   }
