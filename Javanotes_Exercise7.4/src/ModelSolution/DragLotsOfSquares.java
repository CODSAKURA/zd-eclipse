...
public class DragLotsOfSquares extends Application {
        ...
        if (evt.isShiftDown() || evt.getButton() == MouseButton.SECONDARY) {  
            ...
            for (int i = squares.size() - 1; i >= 0; i--) {
                ...
                if ( x >= cx - 50 && x <= cx + 50 && y >= cy - 50 && y <= cy + 50) {
                    ...
                    offsetX = x - cx;	//OffsetX is negative or positive both will work.
                    offsetY = y - cy;	//OffsetY is negative or positive both will work.
    ...
    public void mouseDragged(MouseEvent evt) { 
        ...
        double x = evt.getX();
        double y = evt.getY();
        draggedSquare.x = x - offsetX; //No matter offsetX is negative or positive, both will work.
        draggedSquare.y = y - offsetY;	//No matter offsetY is negative or positive, both will work.
