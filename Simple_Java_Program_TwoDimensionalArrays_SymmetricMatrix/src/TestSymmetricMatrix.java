...
public class TestSymmetricMatrix {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println("Below denotes a matrix which entries below the diagonal show the row number,");
        System.out.println("entries above the diagonal show the column number:");
        System.out.println();
        for (int row = 0; row < n; row++) {
            System.out.print("    ");
            for (int col = 0; col < n; col++) {
