...
public class TextInputDemo extends Application {
    ...
    public void start(Stage stage) {
        ...
        BorderPane.setMargin(contentInput, new Insets(2));  // Set black margins around TextArea components. You can change 2 to 50 to make the changes more obvious.
        BorderPane.setMargin(titleInput, new Insets(2,2,0,2));	//Set black margins around TextField components. You can change 2 to 50 to make the changes more obvious.
