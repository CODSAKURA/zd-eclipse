...
public class TryStatementDemo {
    ...
    static class TestResource implements AutoCloseable {
        ...
        public void close() {
            ...
            System.out.println("TestResource object #" +
            	...
            	// If you uncomment above code, it will first close all the objects by running
            	// all the codes in the close method even if there is an exception code 
            	// in the close method code, then it will go to the main method to run the 
            	// codes in "finally" blocks, eventually it will come back to run the exception 
            	// code in the close method code one by one.
        }
    }
    ...
    public static void main(String[] args) {
        ...
        try( Scanner in = new Scanner(System.in); 
            ...
            System.out.print("Unrelated Question: What's your favorite number? ");
            
                // The next line will throw NoSuchElementException if the user's
                // input is not a legal integer.
            int n = in.nextInt();
            
            System.out.println( n + " is your favorite number i see.");
