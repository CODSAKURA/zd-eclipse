...
public class LengthConverter2 {
     ...
     * Caution: This method will make changes on the whole program. Specifically, it will make the program to consider
     * the next non-blank char even if ch is not a global value. But it will skip a blank space once. For instance,
     * "12 miles 13 miles" will be "12miles 13 miles"
     */
    ...
    static double readMeasurement() {
        ...
        skipBlanks();
        ch = TextIO.peek(); // Getting the first input as a char no matter it is a numerical value or not
        ...
        while (ch != '\n') {
            ...
            measurement = TextIO.getDouble(); //getDouble will only obtain the double values even the input is "12miles", measurement will be "12" and "miles" will be pending.
            skipBlanks();	// This will skip the blanks once: if input is "12 miles 13mi" then, it will be 12miles 13mi. The middle space will not skip.
            				// if input is "12miles 13mi", the result will still be "12miles 13mi". It will skip nothing.
            if (TextIO.peek() == '\n') {
