...
public class Main extends Application {
	...
	private int callHandleNumber;	//As the animation(timer) will keep calling handle method, we will need something to stop the animation. In the subkiller example,
									//the explosion animation stop due to the boolean variable. Here I use the times of calling handle method to stop animation.
	...
	public void start(Stage stage) {		
		...
		button.setPrefWidth(100);	//Changing the default width. Without it, it will be default width.
