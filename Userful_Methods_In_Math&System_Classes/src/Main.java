...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        startTime = System.nanoTime();//System.nanoTime() returns the number of nanoseconds since some arbitrary starting time
        ...
        System.out.println( Math.random() );//Math.random(), which returns a randomly chosen double in the range 0.0 <= Math.random() < 1.0.
        ...
        endTime = System.nanoTime(); // calculate the time the computer used to process your program
