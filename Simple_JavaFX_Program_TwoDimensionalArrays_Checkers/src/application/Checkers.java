...
public class Checkers extends Application {
    ...
    public void start(Stage stage) {
        ...
        /*Without the following two lines, the pane will only arrange its size that 
         *is suitable for its managed items(board and message).
         *
         *With the following two lines, except the pane arrange its size that is
         *suitable for its managed items, it also contain more spaces to display
         *the unmanaged items(resignButton and newGameButton)
         *
         *That is the reason why if the preferred size were not set, the unmanaged buttons
         *would not be included in the Pane's computed preferred size.
         **/
